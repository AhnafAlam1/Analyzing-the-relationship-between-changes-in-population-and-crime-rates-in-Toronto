...
data_toronto <- read_csv("crime_data.csv")
```
...
```{r}
#| label: tbl-one
#| tbl-cap: "Summary statistics table for count of crime and rates of crimes across select five Toronto neighbourhoods"
#| warning: false
#| message: false
#| echo: false
...
data_toronto_clean |>
  ...
  theme(legend.position = "bottom", plot.title = element_text(size = 8), axis.title = element_text(size = 6)) +
  ggtitle("Autohefts count and population")
